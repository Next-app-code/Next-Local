export interface NodeDefinition {
  ...
  label: string;
  description: string;
  inputs: { id: string; name: string; type: string; dataType: string; required?: boolean }[];
  outputs: { id: string; name: string; type: string; dataType: string }[];
  color: string;
}
...
export const nodeDefinitions: NodeDefinition[] = [
  // RPC Nodes
  {
    ...
    color: '#a855f7',
    inputs: [{ id: 'endpoint', name: 'Endpoint', type: 'input', dataType: 'string', required: true }],
    outputs: [{ id: 'connection', name: 'Connection', type: 'output', dataType: 'connection' }],
  },
  {
    type: 'get-balance',
    category: 'rpc',
  ...
  },
  {
    ...
    color: '#a855f7',
    inputs: [{ id: 'connection', name: 'Connection', type: 'input', dataType: 'connection', required: true }],
    outputs: [{ id: 'slot', name: 'Slot', type: 'output', dataType: 'number' }],
  },
  {
    ...
    color: '#a855f7',
    inputs: [{ id: 'connection', name: 'Connection', type: 'input', dataType: 'connection', required: true }],
    outputs: [{ id: 'blockHeight', name: 'Block Height', type: 'output', dataType: 'number' }],
  },
  {
  ...
  },
  {
    ...
    color: '#ffe66d',
    inputs: [{ id: 'lamports', name: 'Lamports', type: 'input', dataType: 'number', required: true }],
    outputs: [{ id: 'sol', name: 'SOL', type: 'output', dataType: 'number' }],
  },
  {
    ...
    color: '#ffe66d',
    inputs: [{ id: 'sol', name: 'SOL', type: 'input', dataType: 'number', required: true }],
    outputs: [{ id: 'lamports', name: 'Lamports', type: 'output', dataType: 'number' }],
  },
  ...
  },
  {
    ...
    outputs: [{ id: 'result', name: 'Result', type: 'output', dataType: 'boolean' }],
  },
  {
    type: 'logic-or',
    category: 'logic',
  ...
  },
  {
    ...
    color: '#ec4899',
    inputs: [{ id: 'a', name: 'Input', type: 'input', dataType: 'boolean', required: true }],
    outputs: [{ id: 'result', name: 'Result', type: 'output', dataType: 'boolean' }],
  },
  {
    type: 'logic-switch',
  ...
  },
  {
    ...
    color: '#06b6d4',
    inputs: [],
    outputs: [{ id: 'publicKey', name: 'Public Key', type: 'output', dataType: 'publickey' }],
  },
  {
    type: 'input-boolean',
    category: 'input',
    ...
    color: '#06b6d4',
    inputs: [],
    outputs: [{ id: 'value', name: 'Value', type: 'output', dataType: 'boolean' }],
  },
  ...
  // Output Nodes
  {
    ...
    color: '#8b5cf6',
    inputs: [{ id: 'value', name: 'Value', type: 'input', dataType: 'any', required: true }],
    outputs: [],
  },
  {
    type: 'output-log',
  ...
  // Utility Nodes
  {
    ...
    inputs: [
      ...
      { id: 'ms', name: 'Milliseconds', type: 'input', dataType: 'number', required: true },
    ],
  ...
  },
  {
    ...
    color: '#6b7280',
    inputs: [{ id: 'json', name: 'JSON String', type: 'input', dataType: 'string', required: true }],
    outputs: [{ id: 'object', name: 'Object', type: 'output', dataType: 'object' }],
  },
  {
    ...
    color: '#6b7280',
    inputs: [{ id: 'object', name: 'Object', type: 'input', dataType: 'object', required: true }],
    outputs: [{ id: 'json', name: 'JSON String', type: 'output', dataType: 'string' }],
  },
  {
    ...
    outputs: [{ id: 'value', name: 'Value', type: 'output', dataType: 'any' }],
  },
];
